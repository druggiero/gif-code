class Grammar {
  ...
  /*Grammars need at least four arguments: 
   ...
   They also take parameter definitions. //update comment
   */
    ...
    for (int j = 0; j<axiom.length(); j++) { 
      ...
      for (int i = 0; i<productions.length; i++) {
        ...
        //When symbol *is* parametric, check conditions, and pass variable
          ...
          //Figure out condition, if there is one.
          ...
          //must construct what we're building.
          //passing..but this required to figure out condition!
      ...
      if (ruleApplied == false) {
        //BUG ALERT wanna figure out why the extra (0)s at the end...
